...
const projectsData = [
  ...
  },
  {
    ...
    status: 'Completed',
    image:
      'https://images.unsplash.com/photo-1634351356743-05de62a4b80b?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.7,
    scale: '300+ Women',
  },
  {
  ...
  },
  {
    ...
    status: 'Completed',
    image:
      'https://images.unsplash.com/photo-1604906145290-c92a636a9617?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.8,
    scale: '50+ Centers',
  },
  {
    ...
    status: 'Running',
    image:
      'https://images.unsplash.com/photo-1668522907255-62950845ff46?q=80&w=2026&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.8,
    scale: '50+ Centers',
  },
  {
  ...
  },
  {
    ...
    status: 'Completed',
    image:
      'https://images.unsplash.com/photo-1582886986754-51997372b668?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.8,
    scale: '50+ Centers',
  },
  {
    ...
    status: 'Running',
    image:
      'https://images.unsplash.com/photo-1660015154781-9ac182923e02?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.8,
    scale: '50+ Centers',
  },
  {
  ...
  },
  {
    ...
    status: 'Running',
    image:
      'https://images.unsplash.com/photo-1722415165787-f212a7343d3f?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.6,
    scale: '150+ Animals',
  },
  {
    id: 16,
    category: 'Education',
    title: 'Review of Educator Activities',
    status: '24/04/2026',
    image:
      'https://res.cloudinary.com/dc2geexnf/image/upload/v1777820644/WhatsApp_Image_2026-04-26_at_9.23.37_AM_1_pmaxmf.jpg',
    rating: 4.6,
    scale: 'Educator Performance',
  },
];
    ...
    <div className="w-full">
      <section className="relative w-full h-[50vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto">
            Explore our initiatives focused on education, health, environment, and community
            development.
          </p>
        </div>
      </section>
                ...
                <p
                  className={`px-4 py-1.5 rounded-full border text-sm font-medium whitespace-nowrap ${
                    project.status === 'Running'
                      ? 'bg-blue-100 border-[#335288] text-[#1f3f70]'
      ...
      <div className="w-full bg-[#F3F4F6] py-10 px-4">
        ...
        <div className="columns-1 sm:columns-2 md:columns-3 gap-4 space-y-4">
          {[
            ' https://res.cloudinary.com/dc2geexnf/image/upload/v1777820644/WhatsApp_Image_2026-04-26_at_9.23.36_AM_fybfn5.jpg',
            'https://res.cloudinary.com/dc2geexnf/image/upload/v1777820646/WhatsApp_Image_2026-04-26_at_9.23.38_AM_1_faualb.jpg',
            'https://res.cloudinary.com/dc2geexnf/image/upload/v1777820644/WhatsApp_Image_2026-04-26_at_9.23.37_AM_l8w6rn.jpg',
